...
- **Cursor TOP / Cursor BOTTOM:** New commands, matching Emacs's own `beginning-of-buffer`/`end-of-buffer`. Table-aware: lands inside a table row's leftmost cell when the target line is one.
